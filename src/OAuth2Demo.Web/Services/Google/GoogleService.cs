...
namespace OAuth2Demo.Web.Services.Google
{
    public class GoogleService : IGoogleService
    {
        ...
        private readonly HttpClient _getTokensClient;
        private readonly HttpClient _getUserInfoClient;

        public GoogleService(GoogleServiceSettings settings, IHttpClientFactory httpClientFactory)
        {
            _settings = settings;
            _getTokensClient = httpClientFactory.CreateClient();
            _getUserInfoClient = httpClientFactory.CreateClient();
        }
